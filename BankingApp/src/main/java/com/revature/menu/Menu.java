...
public class Menu {
	...
	//Verifies user input and tracks input attempts
	private int userInput() {
		int option = 2000;
		int i = 0;  //Tracks user attempts for correct input
		do {
			try {
			...
			if(1>option||option>2) {  //negative or greater than 2
...
//isValidPassword(String password):accountMenu()
		for(int i = 0;i<=3;i++) {
